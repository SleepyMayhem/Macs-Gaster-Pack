...
if CLIENT then
language.Add("weapon_love", "Love Gaster")
killicon.Add("weapon_love", "effects/killicons/weapon_love/gaster1", color_white )
SWEP.WepSelectIcon		= surface.GetTextureID("HUD/swepicons/weapon_love/gaster1") 
end

SWEP.Category			= "Mac's Gaster Pack"
SWEP.PrintName			= "Love Gaster"
SWEP.Slot			= 3
SWEP.SlotPos			= 4
SWEP.DrawAmmo			= true
...
SWEP.VElements = {
	...
	["v_element3"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.6, 0.6, 0.6), color = Color(255,200,0, 100), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
        ["v_element8"] = { type = "Model", model = "models/letters/m.mdl", bone = "Base", rel = "", pos = Vector(-0.2, 0.171, -26.88), angle = Angle(180, 180, 135), size = Vector(0.3, 0.3, 0.3), color = Color(255,200,0, 255), surpresslightning = true, material = "kirillman1/noise", skin = 0, bodygroup = {} },
        ["v_element9"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(6.8, -1.3, -20), angle = Angle(0, 0, 45), size = Vector(0.06, 0.07, 0.1), color = Color(255,200,0, 255), surpresslightning = true, material = "moving1", skin = 0, bodygroup = {} },
	["v_element10"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(6.8, -3.9, -11), angle = Angle(0, 0, 90), size = Vector(0.06, 0.07, 0.1), color = Color(255,200,0, 255), surpresslightning = true, material = "moving1", skin = 0, bodygroup = {} },
        ["v_element11"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(-7.8, -1.3, -20), angle = Angle(0, 0, 45), size = Vector(0.06, 0.07, 0.1), color = Color(255,200,0, 255), surpresslightning = true, material = "moving1", skin = 0, bodygroup = {} },
        ["v_element12"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(-2.76, 2.8, -23.5), angle = Angle(90, 0, 90), size = Vector(0.08, 0.1075, 0.1), color = Color(255,200,0, 255), surpresslightning = true, material = "moving1", skin = 0, bodygroup = {} },
		["v_element13"] = { type = "Model", model = "models/letters/l.mdl", bone = "Base", rel = "", pos = Vector(3, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(255,200,0, 255), surpresslightning = true, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
		["v_element4"] = { type = "Model", model = "models/letters/o.mdl", bone = "Base", rel = "", pos = Vector(1, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(255,200,0, 255), surpresslightning = true, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
		["v_element5"] = { type = "Model", model = "models/letters/v.mdl", bone = "Base", rel = "", pos = Vector(-1, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(255,200,0, 255), surpresslightning = true, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
		["v_element6"] = { type = "Model", model = "models/letters/e.mdl", bone = "Base", rel = "", pos = Vector(-3, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(255,200,0, 255), surpresslightning = true, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
}
...
SWEP.WElements = {
	...
	["w_element2"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(23.502, -5.568, -10.129), angle = Angle(-30.803, 21.666, -157.198), size = Vector(0.38, 0.38, 0.38), color = Color(255,255,0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
	["w_element3"] = { type = "Model", model = "models/letters/m.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, -2, -10), angle = Angle(-20, -82, -120), size = Vector(.2, .2, .2), color = Color(255,200,0, 255), surpresslightning = true, material = "kirillman1/noise", skin = 0, bodygroup = {} },
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/love_not_shooting.mp3" ) )
...
function SWEP:Think()
	...
	if( self.Owner:KeyDown( IN_ATTACK ) ) then
		self.Weapon:SetNWBool( "IsGBZapOnNe", true )
	...
	if ( not self.Owner:KeyDown ( IN_ATTACK ) ) then
		self.Weapon:SetNWBool( "IsGBZapOnNe", false )
	end
end
...
if CLIENT then
	...
	hook.Add( "RenderScreenspaceEffects", "BASS.RenderScreenspaceEffects", function()
		for k,v in ipairs( player.GetAll() ) do
			local weap = v:GetActiveWeapon()

			if IsValid( weap ) and weap:GetNWBool( "IsGBZapOnNe", false ) then
				cam.Start3D( EyePos(), EyeAngles() )
					...
					if beamstartpos then
						...
						render.DrawSprite( beamendpos, 512, 512, Color(255,200,0, 0)  )
						render.DrawSprite( beamendpos, 512, 512, Color(255,200,0, 255)  )
					end
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/love_shooting.mp3" ) )
