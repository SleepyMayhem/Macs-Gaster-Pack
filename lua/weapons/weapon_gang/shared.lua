...
if CLIENT then
language.Add("weapon_gang_gaster", "Gang Gaster")
killicon.Add("weapon_gang_gaster", "effects/killicons/weapon_gang_gaster", color_white )
SWEP.WepSelectIcon		= surface.GetTextureID("HUD/swepicons/weapon_gang_gaster/icon") 
end

SWEP.Category			= "Mac's Gaster Pack"
SWEP.PrintName			= "Gang Gaster"
SWEP.Slot			= 3
SWEP.SlotPos			= 4
SWEP.DrawAmmo			= true
...
SWEP.VElements = {
	["v_element"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.617), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(0, 0, 255, 255), surpresslightning = true, material = "random-supreme", skin = 0, bodygroup = {} },
	["v_element2"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 0, 0, 255), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
	["v_element3"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.6, 0.6, 0.6), color = Color(0, 0, 255, 100), surpresslightning = true, material = "", skin = 0, bodygroup = {} },
        ["v_element8"] = { type = "Model", model = "models/letters/m.mdl", bone = "Base", rel = "", pos = Vector(-0.2, 0.171, -26.88), angle = Angle(180, 180, 135), size = Vector(0.3, 0.3, 0.3), color = Color(255, 0, 0, 255), surpresslightning = true, material = "kirillman1/noise", skin = 0, bodygroup = {} },
	...
	["v_element10"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(6.8, -3.9, -11), angle = Angle(0, 0, 90), size = Vector(0.06, 0.07, 0.1), color = Color(0, 0, 255, 255), surpresslightning = true, material = "moving1", skin = 0, bodygroup = {} },
		...
		["v_element4"] = { type = "Model", model = "models/letters/g.mdl", bone = "Base", rel = "", pos = Vector(3.6, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(255, 0, 0, 255), surpresslightning = true, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
		["v_element5"] = { type = "Model", model = "models/letters/a.mdl", bone = "Base", rel = "", pos = Vector(1.4, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(0, 0, 255, 255), surpresslightning = true, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
		["v_element6"] = { type = "Model", model = "models/letters/n.mdl", bone = "Base", rel = "", pos = Vector(-0.9, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(255, 0, 0, 255), surpresslightning = true, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} },
		["v_element7"] = { type = "Model", model = "models/letters/g.mdl", bone = "Base", rel = "", pos = Vector(-3.1, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(0, 0, 255, 255), surpresslightning = true, material = "models/player/shared/ice_player", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_element"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.817, -0.159, 0.344), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.109, 0.109, 0.109), color = Color(0, 0, 255, 255), surpresslightning = true, material = "random-supreme", skin = 0, bodygroup = {} },
	["w_element2"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(23.502, -5.568, -10.129), angle = Angle(-30.803, 21.666, -157.198), size = Vector(0.37, 0.37, 0.37), color = Color(1, 1, 1), surpresslightning = true, material = "debug/env_cubemap_model", skin = 0, bodygroup = {} },
	...
	["w_element3"] = { type = "Model", model = "models/letters/m.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, -2, -10), angle = Angle(-20, -82, -120), size = Vector(.2, .2, .2), color = Color(255, 0, 0, 255), surpresslightning = true, material = "kirillman1/noise", skin = 0, bodygroup = {} },
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/gang_not_shooting.mp3", 61, 100 ) )
...
if CLIENT then
	...
	hook.Add( "RenderScreenspaceEffects", "PARTY.RenderScreenspaceEffects", function()
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/gang_shooting.mp3" ) )
