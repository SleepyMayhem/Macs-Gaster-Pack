...
if CLIENT then
language.Add("weapon_bang_gaster", "Bang Gaster")
killicon.Add("weapon_bang_gaster", "effects/killicons/weapon_bang_gaster", color_white )
SWEP.WepSelectIcon		= surface.GetTextureID("HUD/swepicons/weapon_bang_gaster/icon") 
end

SWEP.Category			= "Mac's Gaster Pack"
SWEP.PrintName			= "Bang Gaster"
SWEP.Slot			= 3
SWEP.SlotPos			= 4
SWEP.DrawAmmo			= true
...
SWEP.VElements = {
	["v_element"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.617), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
	["v_element2"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
	["v_element3"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "Base", rel = "", pos = Vector(0, -2.991, 10.357), angle = Angle(90, 0, -90), size = Vector(0.6, 0.6, 0.6), color = Color(255, 200, 0, 100), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
        ["v_element8"] = { type = "Model", model = "models/letters/m.mdl", bone = "Base", rel = "", pos = Vector(-0.2, 0.171, -26.88), angle = Angle(180, 180, 135), size = Vector(0.3, 0.3, 0.3), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
        ["v_element9"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(6.8, -1.3, -20), angle = Angle(0, 0, 45), size = Vector(0.06, 0.07, 0.1), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
	["v_element10"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(6.8, -3.9, -11), angle = Angle(0, 0, 90), size = Vector(0.06, 0.07, 0.1), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
        ["v_element11"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(-7.8, -1.3, -20), angle = Angle(0, 0, 45), size = Vector(0.06, 0.07, 0.1), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
        ["v_element12"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(-2.76, 2.8, -23.5), angle = Angle(90, 0, 90), size = Vector(0.08, 0.1075, 0.1), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
		["v_element4"] = { type = "Model", model = "models/letters/b.mdl", bone = "Base", rel = "", pos = Vector(3.6, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
		["v_element5"] = { type = "Model", model = "models/letters/a.mdl", bone = "Base", rel = "", pos = Vector(1.4, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
		["v_element6"] = { type = "Model", model = "models/letters/n.mdl", bone = "Base", rel = "", pos = Vector(-0.9, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
		["v_element7"] = { type = "Model", model = "models/letters/g.mdl", bone = "Base", rel = "", pos = Vector(-3.1, -5, -18.88), angle = Angle(180, 180, 140), size = Vector(0.1, 0.1, 0.1), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_element"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.817, -0.159, 0.344), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.109, 0.109, 0.109), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
	["w_element2"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(23.502, -5.568, -10.129), angle = Angle(-30.803, 21.666, -157.198), size = Vector(0.37, 0.37, 0.37), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
	["w_element2"] = { type = "Model", model = "models/evangelos/undertale/gasterblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(23.502, -5.568, -10.129), angle = Angle(-30.803, 21.666, -157.198), size = Vector(0.38, 0.38, 0.38), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
	["w_element3"] = { type = "Model", model = "models/letters/m.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, -2, -10), angle = Angle(-20, -82, -120), size = Vector(.2, .2, .2), color = Color(255, 200, 0, 255), surpresslightning = true, material = "gold_tool/australium", skin = 0, bodygroup = {} },
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/bang_not_shooting.wav", 61, 100 ) )
...
function SWEP:Think()
	...
	if( self.Owner:KeyDown( IN_ATTACK ) ) then
		self.Weapon:SetNWBool( "IsGBZapOnNu", true )
	...
	if ( not self.Owner:KeyDown ( IN_ATTACK ) ) then
		self.Weapon:SetNWBool( "IsGBZapOnNu", false )
	end
end
...
if CLIENT then
	...
	hook.Add( "RenderScreenspaceEffects", "CHOP.RenderScreenspaceEffects", function()
		for k,v in ipairs( player.GetAll() ) do
			local weap = v:GetActiveWeapon()

			if IsValid( weap ) and weap:GetNWBool( "IsGBZapOnNu", false ) then
				cam.Start3D( EyePos(), EyeAngles() )
					...
					if beamstartpos then
						...
						render.DrawBeam( beamstartpos, beamendpos, size, 10, 2, Color(255,200,0, 255)  )
						render.DrawBeam( beamstartpos, beamendpos, size, 10, 2, Color(255,200,0, 255)  )
						render.DrawBeam( beamstartpos, beamendpos, size, 10, 2, Color(255,200,0, 255)  )
						render.DrawBeam( beamstartpos, beamendpos, size, 10, 2, Color(255,200,0, 255)  )
						render.SetMaterial( LaserSpriteGBN )
						render.DrawSprite( beamendpos, 512, 512, Color(255,200,0, 255)  )
						render.DrawSprite( beamendpos, 512, 512, Color(255,200,0, 255)  )
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/bang_shooting.mp3" ) )
