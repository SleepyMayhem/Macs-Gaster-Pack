...
if CLIENT then
language.Add("weapon_halloween", "Halloween Gaster")
killicon.Add("weapon_halloween", "effects/killicons/weapon_halloween/gaster1", color_white )
SWEP.WepSelectIcon		= surface.GetTextureID("HUD/swepicons/weapon_halloween/gaster1") 
end

SWEP.Category			= "Mac's Gaster Pack"
SWEP.PrintName			= "Halloween Gaster"
SWEP.Slot			= 3
SWEP.SlotPos			= 4
SWEP.DrawAmmo			= true
...
SWEP.Secondary.NumberofShots 	= 200
...
SWEP.VElements = {
	["v_element"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "Base", rel = "", pos = Vector(-0.917, 18.593, 0.617), angle = Angle(-90, 90, 0), size = Vector(0.2, 0.2, 0.2), color = Color(0, 0, 0, 255), surpresslightning = true, material = "phoenix_storms/black_chrome", skin = 0, bodygroup = {} },
	["v_element2"] = { type = "Model", model = "models/halloween/pumpkin_02.mdl", bone = "Base", rel = "", pos = Vector(0, 8.991, 15.357), angle = Angle(90, 0, -90), size = Vector(0.9, 0.9, 0.9), color = Color(254,254,254,255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["v_element8"] = { type = "Model", model = "models/letters/m.mdl", bone = "Base", rel = "", pos = Vector(-0.2, 0.171, -26.88), angle = Angle(180, 180, 135), size = Vector(0.3, 0.3, 0.3), color = Color(255,153,0,255), surpresslightning = true, material = "models/effects/splode_sheet", skin = 0, bodygroup = {} },
        ["v_element9"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(6.8, -1.3, -20), angle = Angle(0, 0, 45), size = Vector(0.06, 0.07, 0.1), color = Color(255,153,0,255), surpresslightning = true, material = "models/effects/splode_sheet", skin = 0, bodygroup = {} },
	["v_element10"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(6.8, -3.9, -11), angle = Angle(0, 0, 90), size = Vector(0.06, 0.07, 0.1), color = Color(255,153,0,255), surpresslightning = true, material = "models/effects/splode_sheet", skin = 0, bodygroup = {} },
        ["v_element11"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(-7.8, -1.3, -20), angle = Angle(0, 0, 45), size = Vector(0.06, 0.07, 0.1), color = Color(255,153,0,255), surpresslightning = true, material = "models/effects/splode_sheet", skin = 0, bodygroup = {} },
        ["v_element12"] = { type = "Model", model = "models/hunter/blocks/cube025x3x025.mdl", bone = "Base", rel = "", pos = Vector(-2.76, 2.8, -23.5), angle = Angle(90, 0, 90), size = Vector(0.08, 0.1075, 0.1), color = Color(255,153,0,255), surpresslightning = true, material = "models/effects/splode_sheet", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["w_element"] = { type = "Model", model = "models/props_questionableethics/qe_primarylase5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.817, -0.159, 0.344), angle = Angle(175.675, 11.01, -21.651), size = Vector(0.109, 0.109, 0.109), color = Color(0,0,0,255), surpresslightning = true, material = "phoenix_storms/black_chrome", skin = 0, bodygroup = {} },
	["w_element2"] = { type = "Model", model = "models/halloween/pumpkin_02.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(34.502, -5.568, -5.129), angle = Angle(-10.803, 5.666, -157.198), size = Vector(0.47, 0.47, 0.47), color = Color(255,255,255,255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["w_element3"] = { type = "Model", model = "models/letters/m.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, -2, -10), angle = Angle(-20, -82, -120), size = Vector(.2, .2, .2), color = Color(255,153,0,255), surpresslightning = true, material = "models/effects/splode_sheet", skin = 0, bodygroup = {} },
}
...
function SWEP:Deploy()
	...
	self.BeatSound = CreateSound( self.Owner, Sound( "weapons/gblaster/halloween_not_shooting.mp3" ) )
...
function SWEP:Think()
	...
	if( self.Owner:KeyDown( IN_ATTACK ) ) then
		self.Weapon:SetNWBool( "IsGBZapOnNggg", true )
	...
	if ( not self.Owner:KeyDown ( IN_ATTACK ) ) then
		self.Weapon:SetNWBool( "IsGBZapOnNggg", false )
	end
end
...
if CLIENT then
	...
	hook.Add( "RenderScreenspaceEffects", "ULTRA.RenderScreenspaceEffects", function()
		for k,v in ipairs( player.GetAll() ) do
			...
			if IsValid( weap ) and weap:GetNWBool( "IsGBZapOnNggg", false ) then
...
function SWEP:PrimaryAttack()
	...
	if self.Owner:KeyDown(IN_ATTACK) and self.CandoSpecial == true then
		...
		if self.Owner:IsPlayer() then
			if ( self.LoopSound ) then
				...
				self.LoopSound = CreateSound( self.Owner, Sound( "weapons/gblaster/halloween_shooting.mp3" ) )
	...
	local bullet = {} 
		...
		bullet.TracerName = "halloween_ray"
...
--if ( !self:CanSecondaryAttack() ) then return end
	...
	local bullet = {} 
		...
		bullet.Damage = self.Primary.Damage
		bullet.AmmoType = self.Primary.Ammo
		bullet.TracerName = "halloween_gblaster_ray"
		bullet.Callback = function(attacker, trace, dmginfo)
						local g = math.random( 1, 3 )
						if ( g == 1 ) then
						dmginfo:SetDamageType(DMG_AIRBOAT)
...
function SWEP:DrawHUD()
    ...
    surface.SetDrawColor(Color(255,153,0,200))
    ...
    surface.SetDrawColor(255,153,0,200)
