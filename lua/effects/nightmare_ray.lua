...
~ server ip: 51.81.7.127_27015 ~ 
~ file: addons/murder-networks-weapons/lua/effects/nightmare_ray.lua ~
...
function EFFECT:Render()
	...
	render.DrawBeam( a, self.EndPos, v2 * 150, 0, self.Dist / 400, Color( 200,10,10, v2 * 255 ) )
