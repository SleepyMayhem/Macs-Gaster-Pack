...
~ server ip: 135.148.30.18_27018 ~ 
~ file: addons/custom-gasters/lua/effects/halloween_gblaster_ray.lua ~
...
function EFFECT:Render()
	...
	render.DrawBeam( a, self.EndPos, v2 * 50, 0, self.Dist / 400, Color( 255, 100, 0, v2 * 255 ) )
