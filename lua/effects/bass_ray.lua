...
function EFFECT:Render()
	...
	randombeam = math.random(1, 2)
    		if (randombeam == 1) then
        		render.DrawBeam( a, self.EndPos, v2 * 50, 10, self.Dist / 400, Color(190, 150, 35,  255 ) )
    		elseif (randombeam == 2) then
        		render.DrawBeam( a, self.EndPos, v2 * 50, 10, self.Dist / 400, Color(133, 40, 40, 255 ) )
    	end
end
